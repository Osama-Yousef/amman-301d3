...
let oneLinerSum = (a, b, c, d) => a + b + c + d;
console.log(oneLinerSum(1, 2, 3, 4));
...
// it refers to student object with a name " joe "
// 2. What is "this" when joe.scopeArrow() is invoked?
// it refers to window object 
// 3. Explain why "this" is different when an arrow function is used.

//Arrow functions perform lexical binding and uses (takes) the surrounding scope as the scope of this ,
//because arrow functions dont have their own scope 
