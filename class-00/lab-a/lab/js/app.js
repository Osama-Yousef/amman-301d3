...
function displayPics(){
  ...
  // because when we declare the variable (rando)  using const , this variable became only locally defined to the function who contains this variable,so when we used console.log(rando) globally we had an error  
